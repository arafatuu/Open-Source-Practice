...
<div class="row log">
<div class="col-sm-10">
<div class=""><h3 style="text-align:center;">Problems verdict</h3></div>
</div>
...
//$input=$r4['tc'];
	...
	if($check==0)
	{
		...
		{
		 // $fr="";
		 echo "<div class=\"row\"><div class=\"col-sm-5\"></div><div class=\"col-sm-5\"><div class=\"alert alert-success\"><strong>Accepted!</strong> Thanks for your submission!!</div></div><div class=\"col-sm-2\"></div></div><br>";
		}
		else
		{
		  //$fr="";
		  			echo "<div class=\"row\"><div class=\"col-sm-5\"></div><div class=\"col-sm-5\"><div class=\"alert alert-success\"><strong>Wrong Ans!</strong> Thanks for your Passion!!</div></div><div class=\"col-sm-2\"></div></div><br>";
